...
# combined effect
opt_dose_combined, opt_effect_combined = steepest_ascent(lambda x: combined_effect(x, x, x), x0=1.0)
...
# combined effect
combined_opt_dose_nm, combined_opt_effect_nm = newtons_method(lambda x: combined_effect(x, x, x), x0=1.0)
print(f"Newton's Method - Optimal Combined Dose: {combined_opt_dose_nm:.2f} mg")
print(f"Newton's Method - Optimal Combined Effect: {combined_opt_effect_nm*100:.2f}%")
# %%
metformin_lambda = 0
for i in range(50):
